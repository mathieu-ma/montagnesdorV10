...
import fr.montagnesdor.restaurant.struts.forms.ChangeEntryDateForm;
 ...
 */
public class ChangeEntryDateAction extends Action
{
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		ChangeEntryDateForm changeEntryDateForm = (ChangeEntryDateForm) form;
		String password = changeEntryDateForm.getPassword();
		...
		if(userSession.getLevelPass1()!=null)
		{
			...
			{
				request.setAttribute("date", changeEntryDateForm.getDate()+"");
				request.setAttribute("month", changeEntryDateForm.getMonth()+"");
				request.setAttribute("year", changeEntryDateForm.getYear()+"");
			}
		}
		else
